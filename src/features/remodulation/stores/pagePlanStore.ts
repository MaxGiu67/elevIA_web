...
const DEFAULT_PLAN: PagePlan = {
  ...
  blocks: [
    ...
    { type: 'problems', priority: 2, visibility: 'visible' },
    { type: 'use_cases', priority: 3, visibility: 'visible' },
    { type: 'features', priority: 4, visibility: 'visible' },
    { type: 'stats', priority: 5, visibility: 'visible' },
